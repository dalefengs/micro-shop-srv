...
NACOS = {
    ...
    "user": "nacos",
    "password": "000",
    "name_space": "383cdcfc-f625-4d46-a2bd-908c20eac5f7",  # 命名空间
    "group": "dev",
    "order-srv_data_id": "order-srv",
    "db_data_id": "db",
}
...
# 默认配置0
config = json.loads(nacos_client.get_config(NACOS["order-srv_data_id"], NACOS["group"]))
...
nacos_client.add_config_watcher(NACOS["order-srv_data_id"], NACOS["group"], update_cfg)
