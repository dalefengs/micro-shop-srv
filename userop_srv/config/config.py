...
NACOS = {
    ...
    "user": "nacos",
    "password": "000",
    "name_space": "4b3b728e-2b65-4feb-836e-d349a3819650",  # 命名空间
    "group": "dev",
    "userop_srv_data_id": "userop-srv",
    "db_data_id": "db",
}
...
# 默认配置0
config = json.loads(nacos_client.get_config(NACOS["userop_srv_data_id"], NACOS["group"]))
...
nacos_client.add_config_watcher(NACOS["userop_srv_data_id"], NACOS["group"], update_cfg)
